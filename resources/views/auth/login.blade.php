...
<html lang="en" class="light-style  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('template-assets') }}" data-template="vertical-menu-template-free">
  ...
  <head>
    ...
    <title>Login| Simaska</title>
    
    <meta name="description" content="Aplikasi Kesekretariatan Terpadu" />
    <meta name="keywords" content="simaska, pt-denpasar, baliagung">
    <!-- Canonical SEO -->
...
<body >
    ...
    <!-- Content -->
<div class="w-100 h-100 " style="background-image: url('{{ asset('img/background.jpeg') }}'); background-repeat:no-repeat; background-position: center; background-size: cover;">
...
<img src="{{ asset('img/logo pt.png') }}" alt="" width="50rem">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">V.1.0.0</span>
                            </a>
                        </div>
                        <!-- /Logo -->

                        <form id="formAuthentication" class="mb-3" action="{{ url('attemptlogin') }}" method="POST">
                            @csrf
                            <div class="mb-3">
