    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit petugas PTSP</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ url('review/tambah_petugas_ptsp') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                       ...
                       <input type="text" name="department" id="" class="form-control" value="{{ $data->department }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <select name="unit_id" id="" class="form-control">
                            ...
                            @foreach ($unit as $u)
                            <option value="{{ $u->id }}" @selected($u->id==$data->unit_id)>{{ $u->unit_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
